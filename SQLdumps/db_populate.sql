...
insert into qualification values (1, 1)
insert into employee values ('Brian', 'Carroll', 55946485, 'briroll@gmail.com', 'brca')
insert into qualification values (1, 2)
-- three for paintball
insert into employee values ('Vicky', 'Fates', 58015850, 'vfdrm@yahoo.com', 'vifa')
insert into qualification values (2, 3)
insert into employee values ('Mario', 'Duplantier', 55666445, 'duplo@yahoo.com', 'madu')
insert into qualification values (2, 4)
insert into employee values ('Chris', 'Adler', 90546854, 'adler@yahoo.com', 'chad')
insert into qualification values (2, 5)
-- four for bow tag
insert into employee values ('Tosin', 'Abasi', 77974568, 'ta@aal.com', 'toab')
insert into qualification values (3, 6)
insert into employee values ('Yvette', 'Young', 79415687, 'yyoung@sberg.com', 'yvyo')
insert into qualification values (3, 7)
insert into employee values ('Sarah', 'Longfield', 56484892, 'inthefield@yourgarden.com', 'salo')
insert into qualification values (3, 8)
insert into employee values ('Rob', 'Scallon', 34568741, 'iamashovel@yourgarden.com', 'rosc')
insert into qualification values (3, 9)

-- now let's create some reservations
insert into reservation values ('Mimir L Poulsen', 71190212, 'MimirLPoulsen@jourrapide.com', 4, '2017-06-19', 2, 1, null)
insert into reservation values ('Nicklas K Mogensen', 24127298, 'NicklasKMogensen@dayrep.com', 6, '2017-06-04', 5, 1, null)
insert into reservation values ('Tobias P Iversen', 24213720, 'TobiasPIversen@rhyta.com', 4, '2017-06-23', 4, 2, null)
insert into reservation values ('Liv M Berg', 81750718, 'LivMBerg@jourrapide.com', 4, '2017-06-28', 2, 3, null)
...
insert into reservation values ('Silas S Holst', 71190212, 'SilasSHolst@dayrep.com', 5, '2017-07-02', 7, 1, null)
insert into reservation values ('Peter M Brandt', 26924523, 'PeterMBrandt@rhyta.com', 8, '2017-07-02', 4, 1, null)
insert into reservation values ('Tristan R Jespersen', 71787641, 'TristanRJespersen@armyspy.com', 7, '2017-06-08', 7, 2, null)
insert into reservation values ('Isabella J Nygaard', 27472415, 'IsabellaJNygaard@jourrapide.com', 4, '2017-05-29', 5, 1, null)
insert into reservation values ('David T Olesen', 23763759, 'DavidTOlesen@rhyta.com', 8, '2017-05-16', 5, 3, null)
insert into reservation values ('Abellona M Brandt', 25906985, 'AbellonaMBrandt@armyspy.com', 15, '2017-05-25', 6, 3, null)
insert into reservation values ('Ditte L Sørensen', 28701292, 'DitteLSrensen@dayrep.com', 8, '2017-03-25', 4, 2, null)
